...
class Keyring_Service_Publishiza extends Keyring_Service_Twitter {
	...
	function basic_ui() {
		...
		echo '<h2>' . __( 'Service Management', 'keyring' ) . '</h2>';
		echo '<p><a href="' . Keyring_Util::admin_url( false, array( 'action' => 'services' ) ) . '">' . __( '&larr; Back', 'keyring' ) . '</a></p>';
		echo '<h3>' . sprintf( __( '%s Connection', 'keyring' ), esc_html( $this->get_label() ) ) . '</h3>';
		...
		echo '<input type="submit" name="submit" value="' . __( 'Connect', 'keyring' ) . '" id="submit" class="button-primary">';
